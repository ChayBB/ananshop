...
return [
    ...
    'dashboard' => [
        'index' => [
            ...
            'total-unpaid-invoices' => 'Pending Orders',
    ...
    'catalog' => [
        ...
        'batches' => [
            'index' => [
                ...
                'delete-success' => 'Batch removed and its stock deducted.',

                'datagrid' => [
                    'batch-number' => 'Batch Number',
                    'sku' => 'SKU',
                    'source' => 'Source',
                    'qty-remaining' => 'Remaining / Received',
            ...
            'create' => [
                'receive' => 'Receive Stock',
                'received-success' => 'Stock received.',
                'product' => 'Product',
                'source' => 'Source',
                'qty' => 'Quantity',
                'batch-number' => 'Batch Number',
                'batch-hint' => 'Leave blank to generate automatically.',
                'received-at' => 'Received At',
                'expired-at' => 'Expiry',
                'expiry-hint' => 'Leave blank to use the product shelf life.',
                'unit-cost' => 'Unit Cost',
                'notes' => 'Notes',
                'save' => 'Receive',
                'back' => 'Back',
    ...
    'reporting' => [
        ...
        'stock' => [
            'index' => [
                ...
                'control-center' => 'Stock Control Center',
                'critical' => 'Critical',
                'low' => 'Low',
                'healthy' => 'Healthy',
                'unset' => 'No Max Level',
                'critical-alerts' => 'Critical Alerts',
                'stock-health' => 'Stock Health Overview',
                'total-tracked' => 'Products Tracked',
                'no-critical' => 'No products in the critical band',
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'credit' => 'Credit',
                    'credit-info' => 'Payment method where approved customers can complete their purchase on credit and settle payment within the allotted credit rounds.',
                    'description' => 'Description',
                    'enable' => 'Enable',
