<x-admin::layouts>
    ...
    >
        ...
        <template #header="{
            ...
            <template v-else>
                <div class="row grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] grid-rows-1 gap-3 md:gap-1 items-start md:items-center border-b px-4 py-2.5 dark:border-gray-800 min-w-full">
                    <div
        ...
        <template #body="{
            ...
            <template v-else>
                <div
                    class="row grid grid-cols-1 gap-4 md:grid-cols-[minmax(150px,_2fr)_1fr_1fr] md:gap-0 border-b px-4 py-2.5 transition-all hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-950 min-w-full"
                    v-for="record in available.records"
                >
                    <div class="flex gap-2.5 pb-4 border-b border-dashed border-gray-200 md:border-0 md:pb-0 dark:border-gray-800">
                        @if ($hasPermission)
                            <input
                                type="checkbox"
                    ...
                    <div class="flex flex-col gap-1.5 ps-8 pb-4 border-b border-dashed border-gray-200 md:ps-0 md:border-0 md:pb-0 dark:border-gray-800">
