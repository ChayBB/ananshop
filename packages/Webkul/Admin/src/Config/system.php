...
return [
    ...
    [
        ...
        'key' => 'sales.payment_methods.credit',
        'name' => 'admin::app.configuration.index.sales.payment-methods.credit',
        'info' => 'admin::app.configuration.index.sales.payment-methods.credit-info',
        'sort' => 9,
        'fields' => [
            [
                'name' => 'active',
