    ...
    <head>
        ...
        @php
            ...
            if (in_array(app()->getLocale(), ['ar', 'he', 'fa', 'tr', 'ru', 'uk'])) {
                ...
                $fontPath = [
                    'regular' => str_replace('\\', '/', public_path('fonts/NotoSansSC-Regular.ttf')),
                    'bold'    => str_replace('\\', '/', public_path('fonts/NotoSansSC-Bold.ttf')),
                ];
                ...
                $fontPath = [
                    'regular' => str_replace('\\', '/', public_path('fonts/NotoSansJP-Regular.ttf')),
                    'bold'    => str_replace('\\', '/', public_path('fonts/NotoSansJP-Bold.ttf')),
                ];
                ...
                $fontPath = [
                    'regular' => str_replace('\\', '/', public_path('fonts/Hind-Regular.ttf')),
                    'bold'    => str_replace('\\', '/', public_path('fonts/Hind-Bold.ttf')),
                ];
                ...
                $fontPath = [
                    'regular' => str_replace('\\', '/', public_path('fonts/NotoSansBengali-Regular.ttf')),
                    'bold'    => str_replace('\\', '/', public_path('fonts/NotoSansBengali-Bold.ttf')),
                ];
                ...
                $fontPath = [
                    'regular' => str_replace('\\', '/', public_path('fonts/NotoSansSinhala-Regular.ttf')),
                    'bold'    => str_replace('\\', '/', public_path('fonts/NotoSansSinhala-Bold.ttf')),
                ];
                ...
                $fontPath = [
                    'regular' => str_replace('\\', '/', public_path('fonts/THSarabunNew.ttf')),
                    'bold'    => str_replace('\\', '/', public_path('fonts/THSarabunNew-Bold.ttf')),
                ];
