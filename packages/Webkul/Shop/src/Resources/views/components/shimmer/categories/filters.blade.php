<div class="panel-side journal-scroll grid max-h-[1320px] min-w-[240px] max-w-[260px] grid-cols-[1fr] overflow-y-auto overflow-x-hidden max-xl:min-w-[220px] ltr:pr-5 rtl:pl-5">
