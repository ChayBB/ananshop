            ...
            <div class="grid max-w-[291px] content-start gap-2.5 bg-white p-2.5 max-md:relative max-md:mt-0 max-md:gap-1.5 max-md:px-0 max-md:py-1.5 max-sm:min-w-[170px] max-sm:max-w-[192px]">
                ...
                <div class="action-items flex items-center gap-1.5 mt-2 w-full max-sm:flex-wrap max-sm:gap-1">
                    ...
                    @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                        <div class="flex items-center justify-between rounded-xl border border-navyBlue px-3 py-1 text-sm font-medium select-none shrink-0 min-w-[135px] max-sm:min-w-[106px] max-sm:px-2">
                            <button
                                type="button"
